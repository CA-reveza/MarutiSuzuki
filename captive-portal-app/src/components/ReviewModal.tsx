...
export const ReviewModal: React.FC<ReviewModalProps> = ({
  ...
  const submitAndClose = () => {
    setIsSubmitted(true);
    try {
      sessionStorage.setItem('marutisuzuki_portal_reviewed', 'true');
    } catch (e) {}
        ...
        {isSubmitted ? (
          ...
          <div className="py-8 text-center space-y-3 animate-fade-in">
            ...
            <p className="text-xs text-[#666052] max-w-xs mx-auto">
              Your review helps us continuously improve in-store wayfinding and shopping at Maruti Suzuki.
            </p>
          </div>
        ) : (
          /* REVIEW FORM STATE */
          <div className="space-y-5">
            ...
            <div className="pt-2 border-t border-[#f0ebd9] flex items-center justify-between text-[10px] text-[#888172]">
              <span>Maruti Suzuki Customer Voice</span>

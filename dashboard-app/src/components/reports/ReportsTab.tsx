...
export const ReportsTab: React.FC = () => {
  ...
  const handleDownload = (rep: ReportItem) => {
    ...
    setTimeout(() => {
      ...
      downloadReportFile(rep.title, rep.fileFormat, 'Maruti Suzuki Nationwide');
    }, 400);
  };
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-gray-100 text-gray-700">
                      ...
                      <tr>
                        ...
                        <td className="p-2">Batteries & Electricals</td>
                        <td className="p-2 font-bold">320 / 500</td>
                        <td className="p-2 text-emerald-600 font-bold">Active</td>
                      </tr>
                      <tr>
                        <td className="p-2 font-mono font-bold text-rose-600">SERVICEBUY2</td>
                        <td className="p-2">Lubricants & Fluids</td>
                ...
                <div className="space-y-2">
                  <div className="p-2.5 bg-gray-50 rounded-xl border border-gray-200">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-gray-900">Amaron Flo 12V Battery</span>
                      <span className="text-amber-500 font-bold flex items-center gap-0.5">
                        5.0 ★
                      </span>
                    </div>
                    <p className="text-[11px] text-gray-600 mt-1">
                      "Authentic part delivered within 2 hours in Malad flagship pickup. Loved the packaging!"
                    </p>
                  </div>
                  <div className="p-2.5 bg-gray-50 rounded-xl border border-gray-200">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-gray-900">Genuine 3D Floor Mats</span>
                      <span className="text-amber-500 font-bold flex items-center gap-0.5">
                        4.5 ★
                      </span>
                    </div>
                    <p className="text-[11px] text-gray-600 mt-1">
                      "Great fit and premium material texture. Fitting session at the service bay was quick."
                    </p>
                  </div>
                </div>
              </div>

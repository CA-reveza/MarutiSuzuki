...
export const CustomersTab: React.FC<CustomersTabProps> = ({
  ...
  const [newCategory, setNewCategory] = useState('Genuine Accessories');
  ...
  const handleEnrollSubmit = (e: React.FormEvent) => {
    ...
    setNewPhone('');
    setNewTier('Silver');
    setNewCategory('Genuine Accessories');
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            onClick={() => {
              ...
              downloadReportFile('First_Citizen_Customers_CRM', 'CSV', 'Maruti Suzuki Nationwide', exportRows);
            }}
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-300 focus:bg-white focus:border-[#122B52] rounded-xl py-2 px-3 outline-none cursor-pointer font-medium"
              >
                <option value="Genuine Accessories">Genuine Accessories</option>
                ...
                <option value="Interior & Upholstery">Interior & Upholstery</option>
              </select>
            </div>
          </div>

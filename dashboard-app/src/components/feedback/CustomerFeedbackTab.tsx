...
const INITIAL_REVIEWS: CustomerReview[] = [
  {
    ...
    rating: 5,
    title: "Excellent Accessories Fitting Consultation",
    comment: "The product specialist for genuine accessories was excellent. VIP Lounge billing was seamless and staff offered expert fitment guidance!",
    date: "2026-08-02",
    time: "16:45 PM",
    sentiment: "Delighted",
    verifiedPurchase: true,
    managerResponse: "Thank you Ananya! We are thrilled to hear about your accessories fitting experience at Malad Flagship."
  },
  {
    id: "REV-1002",
    ...
    rating: 5,
    title: "Tyre Replacement Service Excellent",
    comment: "Flawless tyre fitment & balancing at the service bay. Fast First Citizen discount redemption!",
    date: "2026-08-01",
    time: "14:15 PM",
    sentiment: "Delighted",
    verifiedPurchase: true,
  ...
  },
  {
    ...
    rating: 5,
    title: "Periodic Service & Oil Change Masterclass",
    comment: "The service advisor walked me through the full maintenance checklist. Complimentary car wash & double reward points added instantly.",
    date: "2026-07-31",
    time: "18:20 PM",
    sentiment: "Delighted",
    verifiedPurchase: true,
    managerResponse: "We look forward to hosting you at our next service camp Kavita!"
  },
  {
    id: "REV-1004",
  ...
  },
  {
    ...
    rating: 5,
    title: "Body Shop Repair Assistance",
    comment: "Great parts availability and courteous service floor staff. Bumper repair was completed ahead of schedule.",
    date: "2026-07-29",
    time: "15:10 PM",
    sentiment: "Delighted",
    verifiedPurchase: true
              ...
              data.feedbacks.forEach((fb: any) => {
                if (!merged.some(m => m.id === fb.id || (m.customerName === fb.customerName && m.comment === fb.comment))) {
                  merged.unshift({
                    ...
                    customerEmail: fb.customerEmail || fb.email || "shopper@marutisuzukis.in",
                    ...
                    comment: fb.comment || fb.feedback || "Great shopping experience at Maruti Suzuki!",
      ...
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-[18px] p-5 text-white shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-300 mt-1 max-w-2xl">
            Inspect shopper reviews, store service CSAT ratings, and verified buyer testimonials across all Maruti Suzuki branches.
          </p>
        </div>
        <Button
          variant="primary"
          ...
          onClick={() => {
            ...
            downloadReportFile('Maruti Suzuki_CSAT_Reviews_Report', 'CSV', 'All Stores', rows);
          }}
        >

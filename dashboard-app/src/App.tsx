  ...
  const [notifications, setNotifications] = useState<AppNotification[]>([
    {
      ...
      desc: 'Wheel alignment sensor kit down to 1 unit in Malad vault.',
      time: '5 mins ago',
      unread: true,
    },
    {
      id: 'seed-2',
      title: 'Low Stock Alert',
      desc: 'CEAT SecuraDrive 185/65 R15 Tyre down to 4 units in stock.',
      time: '12 mins ago',
      unread: true,
    },
    {
      ...
      desc: 'Order #MS-ORD-98417 placed for ₹11,200 by Black Member.',
      time: '35 mins ago',
      unread: true,
    },
    {
      ...
      desc: 'Timing Belt Kit - K14B Engine is currently Out of Stock.',
      time: '1 hour ago',
      unread: false,
    },
    {
          ...
          if (data && data.success && Array.isArray(data.customers) && isMounted) {
            const apiCusts: Customer[] = data.customers.map((c: any) => {
              ...
              return {
                ...
                preferredCategory: c.preferredCategory || "Genuine Accessories",
              ...
              return prevCoupons.map(cpn => {
                ...
                if (matched.length > 0) {
                  const formattedReds: CouponRedemption[] = matched.map(r => ({
                    ...
                    orderId: r.orderId || `MS-ORD-${Math.floor(90000 + Math.random() * 9999)}`,

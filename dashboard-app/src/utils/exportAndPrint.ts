  ...
  const html = `
    ...
    <html>
      ...
      <body>
        <div class="no-print">
          <div>
            <strong style="font-size: 13px; color: #0f172a;">Maruti Suzuki Tax Invoice</strong>
        ...
        <div class="header">
          <div>
            <div class="brand">MARUTI SUZUKI</div>
        ...
        <div class="footer">
          <p>Maruti Suzuki Limited • GSTIN: 27AAACS1234F1Z5 • Customer Care: 1800-209-2090</p>
          <p>Thank you for shopping with Maruti Suzuki! This is a system-generated Tax Invoice.</p>
        </div>
...
export function downloadReportFile(
  ...
  const fileName = `Maruti Suzuki_${cleanTitle}_${timestamp}.${format.toLowerCase()}`;

  if (format === 'CSV' || format === 'XLSX') {
    let csvContent = `MARUTI SUZUKI RETAIL OPERATIONS REPORT\n`;
